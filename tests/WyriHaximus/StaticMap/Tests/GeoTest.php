...
class GeoTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$box = \WyriHaximus\StaticMap\Geo::calculateBox(new \Imagine\Image\Box(25, 25), \WyriHaximus\StaticMap\Geo::calculatePoint(new \WyriHaximus\StaticMap\LatLng(71, 111), 3));
	 ...
	 */
	public function testCalculatePoint(\WyriHaximus\StaticMap\LatLng $latLon, $zoom, \WyriHaximus\StaticMap\Point $point) {
